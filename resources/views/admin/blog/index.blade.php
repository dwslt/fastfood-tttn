                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$item['title']}}</td>
                                <td> <img width="100px" height="100px" src="{{asset('upload/blog_img/'.$item['image'])}}" alt=""></td>
                                <td>{{$item['description']}}</td>
                                <td>{!!$item['content']!!}</td>
                                <td><a href="edit_blog/{{$item['_id']}}">Edit</a>|<a href="delete_blog/{{$item['_id']}}">Delete</a></td>
                            </tr>
                            <tr>
                            @endforeach
